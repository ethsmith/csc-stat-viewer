...
export interface Insight {
	...
	playerName?: string;
	message: string;
	category: "performance" | "trend" | "role" | "team";
}
...
const getCategoryBadge = (category: Insight["category"]) => {
	...
	return (
		<span className={`text-xs px-2 py-0.5 rounded ${colors[category]} text-white uppercase font-semibold`}>
			{category}
		</span>
	);
};
		...
		return (
			<div className="p-6 bg-gray-800 rounded-lg border border-gray-700">
				...
				<div className="text-center py-8 text-gray-400">
					<p>No insights available yet. Insights will appear as data is analyzed.</p>
				</div>
			</div>
		);
	}
